module Mutations
  class CreateOffer < BaseMutation
    ...
    def resolve(product_id: nil, title: nil, description: nil, start_date: nil, end_date: nil)
  ...
  class UpdateOffer < BaseMutation
    ...
    def resolve(id: nil, title: nil, description: nil, start_date: nil, end_date:  nil)
      current_user = context[:current_user]
